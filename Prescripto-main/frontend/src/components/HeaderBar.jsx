  ...
  const getRoleMenuItems = () => {
    ...
    if (activeRole === 'pharmacy') {
      return [
        ...
        { id: 'requests', label: t('medicineRequests') || 'Medicine Requests', icon: '📦' },
        { id: 'pending-orders', label: t('pendingRequests') || 'Pending Requests', icon: '⏳' },
        { id: 'ready-orders', label: t('readyRequests') || 'Ready Requests', icon: '✅' },
        { id: 'completed-orders', label: t('completedRequests') || 'Completed Requests', icon: '🎉' },
        { id: 'stock', label: t('pharmacyStock') || 'Medicine Stock', icon: '💊' },
    ...
    return [
      ...
      { id: 'medicine-status', label: t('medicineRequests') || 'Medicine Requests', icon: '📦' },
